...
export async function run(opts) {
  ...
  const homepage = resolved.homepage?.ok ? extractHomepage(resolved.homepage.body, origin) : null;
  ...
  return envelope({
    ...
    shareability, leadSignals, bee, robotsReg,
  });
}
...
function envelope(ctx) {
  const {
    ...
    homepage = null, blockedAtRoot = false, shareability = null, leadSignals = null, bee = null, robotsReg = null,
  } = ctx;
