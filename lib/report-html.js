...
<title>${esc(domain)} — Advocacy Grader by JustMeSocial</title>
<style>${CSS}</style>
</head>
<body>
<main>
  ...
  ${categorySection(s)}
  <footer>
    <p>Advocacy Grader by JustMeSocial.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Advocacy Grader by JustMeSocial — ${stats.total} company reports</title>
<style>${CSS}
